  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">审计智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/audit-master')">
        <div class="card-glow"></div>
        <div class="app-icon robot-icon">🤖</div>
        <div class="app-info">
          <div class="app-title">智能问答</div>
      <div class="app-desc">智能问答 是一个基于人工智能技术打造的智能交互系统，专注于为用户提供专业的审计知识解答与实务指导。</div>
        </div>
...
<!--      </div>-->
      ...
      <div class="app-card" @click="navigateTo('/table-sql')">
        <div class="card-glow"></div>
        <div class="app-icon robot-icon">📊</div>
        <div class="app-info">
          <div class="app-title">数据分析</div>
          <div class="app-desc">数据分析 是一个基于人工智能技术的工具，支持上传Excel/CSV文件并使用SQL语句进行数据查询和分析。</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
      ...
      <div class="app-card" @click="navigateTo('/audit-generate')">
        <div class="card-glow"></div>
        <div class="app-icon robot-icon">🤖</div>
        <div class="app-info">
          <div class="app-title">底稿生成</div>
      <div class="app-desc">底稿生成 是利用人工智能技术，根据审计程序和业务数据自动生成结构化、合规性高的审计工作底稿。</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
